...
if __name__ == '__main__':
    ...
    posfile = ['goodgas','dataall2'] #-----poscar in metastr---
    # metafile = ['data_meta'] #-----pos2meta
            ...
            if P_copy[i] != 0:
                ...
                for pot in atom_type.keys():
                    ...
                    if not atom_type_new in list_site_all:
                        ...
                        dis_all.append([[site_dis[pot][0]],[site_dis[pot][1]],[site_dis[pot][2]]])
                        # print(dis_all)
                    else:
